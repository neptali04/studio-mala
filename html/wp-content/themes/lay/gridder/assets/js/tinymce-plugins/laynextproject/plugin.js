/* global tinymce */
tinymce.PluginManager.add( 'laynextproject', function( editor ) {

	editor.addCommand( 'laynextproject', function() {
		laynextproject_controller.doClick( editor.id );
	});
	...
	editor.onNodeChange.add(function(ed, cm, node) {
        ...
        cm.setDisabled('laynextproject', disabled);
    });

	editor.addButton( 'laynextproject', {
		icon: 'laynextproject',
		tooltip: 'Insert next project link',
		cmd: 'laynextproject',
		stateSelector: 'a.laynextproject'
	});

});


var laynextproject_controller = (function(){
